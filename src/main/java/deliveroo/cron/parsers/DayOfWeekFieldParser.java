...
public class DayOfWeekFieldParser extends FieldParser {
    ...
    private static final int MAX_DAY_OF_WEEK_VALUE = 7;
    ...
    public String parseField(String field) throws InvalidFieldValueException {
        // Parse the day of the week field into a list of integer values
        List<Integer> values =  SpecialCharacterParser.parse(field, 1,  MAX_DAY_OF_WEEK_VALUE);
